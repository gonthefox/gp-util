...
,#+end_quote
,#+begin_quote
( wherein said DRM packager is configured to encrypt the digital content based upon the universal DRM layer.)
,#+end_quote
,#+begin_quote
( wherein said DRM packager is configured to tamper-proof or watermark the digital content.)
,#+end_quote
,#+begin_quote
( wherein said DRM packager is configured to tamper-proof or watermark the digital content.)
,#+end_quote
,#+begin_quote
( wherein the DRM packager distributes the digital content over a computer network.)
,#+end_quote
,#+begin_quote
( wherein said computer network is the Internet.)
,#+end_quote
,#+begin_quote
( wherein the content database and the DRM packager are in communication over a computer network.)
,#+end_quote
,#+begin_quote
( wherein said computer network is the Internet.)
,#+end_quote
,#+begin_quote
( wherein the DRM packager further distributes a rights package to the user.)
,#+end_quote
,#+begin_quote
( wherein the rights package is bundled with the digital content.)
,#+end_quote
,#+begin_quote
( wherein the rights package includes a decryption key.)
,#+end_quote
,#+begin_quote
( wherein the rights package includes a decryption key.)
,#+end_quote
,#+begin_quote
( wherein the digital content includes text-based information.)
,#+end_quote
,#+begin_quote
( wherein the digital content includes audio information.)
,#+end_quote
,#+begin_quote
( wherein the digital content include visual information.)
,#+end_quote
,#+begin_quote
( wherein the digital content includes audio and visual information.)
,#+end_quote
,#+begin_quote
( wherein the step of transmitting the digital content includes the step of transmitting the digital content as streaming media.)
,#+end_quote
,#+begin_quote
( wherein the DRM packager is configured, in response to a request from a client to receive the digital content in conformance with a first of the plurality of different DRM implementations, to distribute the digital content together with the universal DRM layer added to the digital content.)
,#+end_quote
,#+begin_quote
...
,#+end_quote
,#+begin_quote
(, wherein the DRM packager bundles a rights package with the digital content prior to transmitting the digital content to the client, and wherein the rights package includes a decryption key for decrypting the digital content.)
,#+end_quote
#+end_example
